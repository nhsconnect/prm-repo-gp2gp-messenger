export const generateEhrExtractResponse = `----=_MIME-Boundary
...
<SOAP-ENV:Envelope xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/" >
    <SOAP-ENV:Header>
        <eb:MessageHeader eb:version="2.0" soap-env:mustUnderstand="1">
            ...
            <eb:MessageData>
                <eb:MessageId>F01B395C-15AD-480C-8FA8-EA930B182788</eb:MessageId>
            ...
            <EhrExtract classCode="EXTRACT" moodCode="EVN">
                ...
                <recordTarget typeCode="RCT">
                    <patient classCode="PAT">
                        <id extension="9465731285" root="2.16.840.1.113883.2.1.4.1"/>
                    </patient>
                </recordTarget>
                <author typeCode="AUT">
                    <time nullFlavor="UNK"/>

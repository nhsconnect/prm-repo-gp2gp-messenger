...
describe('message-utilities', () => {
    it("should keep escaped linebreak symbols unchanged", async () => {
        // given
        const inputXml = "<text>Drinking status on eventdate: &#10;&#10;&#10;   &#13;&#10; Current drinker</text>";
    ...
    it("should keep escaped greater than (>) and less than (<) symbols unchanged", async () => {
        // given
        const inputXml = "<text>Drinking status on eventdate: &lt; &gt; &gt; &lt; Current drinker</text>";
    ...
    it(`should keep escaped apostrophes (') and quotation marks (") unchanged`, async () => {
        // given
        const inputXml = "<agentPerson classCode=\"PSN\" determinerCode=\"INSTANCE\"><name><family>DR &quot;DK NANDI&apos;S &quot;PRACTICE</family></name></agentPerson>";

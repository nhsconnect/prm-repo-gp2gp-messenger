locals {
  ...
  ecs_task_sg_ids    = var.allow_vpn_to_ecs_tasks ? [aws_security_group.ecs-tasks-sg.id, aws_security_group.vpn_to_gp2gp_adaptor_ecs.id] : [aws_security_group.ecs-tasks-sg.id]
